	...
	return(
		<div className="container">
			...
			<div className="image">
				...
				<h3>Shoe 7</h3>
				<h3>$15,00</h3>
				<a onClick={props.addCart} className="addToCart cart7" href="#">Add to Cart</a>
			</div>
			<div className="image">
				<img src={shoe8} alt="Shoe 8" style={imageStyle} />
				<h3>Shoe 8</h3>
				<h3>$15,00</h3>
				<a onClick={props.addCart} className="addToCart cart8" href="#">Add to Cart</a>
			</div>
			<div className="image">
				<img src={shoe9} alt="Shoe 9" style={imageStyle} />
				<h3>Shoe 9</h3>
				<h3>$15,00</h3>
				<a onClick={props.addCart} className="addToCart cart9" href="#">Add to Cart</a>
			</div>
